function indices = pcdownsample_with_index(ptCloudIn, varargin)
...
%     preprocessing step to pcregistericp when the 'pointToPlane' metric is
%     used.
...
%
% See also pointCloud, pcshow, pcregistericp, pctransform
 
%  Copyright 2014 The MathWorks, Inc.
%
% References
% ----------
% Fran�ois Pomerleau, Francis Colas, Roland Siegwart, St�phane Magnenat, 
